...
<svg width="${W}" height="${H}" xmlns="http://www.w3.org/2000/svg">
  ...
  <g font-family="Georgia, 'Times New Roman', serif">
    ...
    <text x="${TEXT_X - 4}" y="282" font-size="64" fill="#362c24">Styled <tspan font-style="italic" fill="#a34e60">by</tspan> Susanne</text>
    <text x="${TEXT_X}" y="360" font-size="28" font-style="italic" fill="#8a3e50">Your wardrobe should feel like</text>
    <text x="${TEXT_X}" y="400" font-size="28" font-style="italic" fill="#8a3e50">the person you’re becoming.</text>
    <rect x="${TEXT_X + 2}" y="448" width="64" height="2" fill="#dda3b0"/>
